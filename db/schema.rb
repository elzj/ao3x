...
ActiveRecord::Schema.define(version: 201604030319571) do
  ...
  create_table "abuse_reports", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "email"
  ...
  create_table "admin_activities", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "admin_id"
    t.integer "target_id"
  ...
  create_table "admin_banners", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.text "content"
  ...
  create_table "admin_blacklisted_emails", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "email"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "admin_post_taggings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "admin_post_tags", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
  ...
  create_table "admin_posts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "admin_id"
    t.string "title"
    t.text "content"
    t.datetime "updated_at"
  ...
  create_table "admin_settings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "archive_faq_translations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "archive_faqs", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "admin_id"
    t.string "title"
    t.datetime "updated_at"
    t.datetime "created_at"
    ...
    t.index ["position"], name: "index_archive_faqs_on_position", unique: true
  ...
  create_table "challenge_assignments", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "challenge_claims", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "collection_id"
    t.integer "creation_id"
    t.string "creation_type"
    t.integer "request_signup_id"
  ...
  create_table "challenge_signups", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "collection_id"
    t.integer "pseud_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "collection_items", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "collection_id"
    t.integer "item_id"
  ...
  create_table "collection_participants", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "collection_id"
    t.integer "pseud_id"
  ...
  create_table "collection_preferences", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "collection_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "collection_profiles", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "collection_id"
  ...
  create_table "common_taggings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "creatorships", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "creation_id"
  ...
  create_table "draft_attachers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "draft_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["draft_id"], name: "index_draft_attachers_on_draft_id", unique: true
  end
  ...
  create_table "external_author_names", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "external_authors", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "email"
  ...
  create_table "external_creatorships", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "creation_id"
    t.string "creation_type"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "external_works", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "url", null: false
  ...
  create_table "fannish_next_of_kins", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id"
    t.integer "kin_id"
    t.string "kin_email"
  ...
  create_table "favorite_tags", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id"
    t.integer "tag_id"
  ...
  create_table "filter_counts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "filter_taggings", primary_key: ["id", "filter_id"], options: "ENGINE=InnoDB DEFAULT CHARSET=utf8\n/*!50100 PARTITION BY KEY (filter_id)\nPARTITIONS 1 */", force: :cascade do |t|
  ...
  create_table "gift_exchanges", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "inbox_comments", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "invite_requests", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "email"
    t.integer "position"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "known_issues", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "admin_id"
    t.string "title"
    t.text "content"
    t.datetime "updated_at"
  ...
  create_table "kudos", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "pseud_id"
    t.integer "commentable_id"
    t.string "commentable_type"
    t.datetime "created_at"
  ...
  create_table "log_items", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "admin_id"
    t.integer "role_id"
  ...
  create_table "message_threads", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "thread"
    t.boolean "read"
    t.boolean "all_from_self"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "messages", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "parent_id"
    t.string "parent_type"
    t.index ["parent_id", "parent_type"], name: "index_messages_on_parent_id_and_parent_type"
  end

  create_table "meta_taggings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "moderated_works", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "owned_set_taggings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "owned_tag_sets", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "potential_match_settings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "potential_matches", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "collection_id"
    t.integer "offer_signup_id"
    t.integer "request_signup_id"
  ...
  create_table "potential_prompt_matches", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["offer_id"], name: "index_potential_prompt_matches_on_offer_id"
    t.index ["potential_match_id"], name: "index_potential_prompt_matches_on_potential_match_id"
    t.index ["request_id"], name: "index_potential_prompt_matches_on_request_id"
  end
  ...
  create_table "prompt_memes", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "prompt_restriction_id"
    t.integer "request_restriction_id"
    t.integer "requests_num_required", default: 1, null: false
  ...
  create_table "prompt_restrictions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "tag_set_id"
  ...
  create_table "prompts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "collection_id"
  ...
  create_table "pseuds", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id"
    t.string "name", null: false
    t.text "description"
  ...
  create_table "question_translations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "questions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "position", default: 1
    t.index ["archive_faq_id", "position"], name: "index_questions_on_archive_faq_id_and_position", unique: true
  end
  ...
  create_table "related_works", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "parent_id"
    t.string "parent_type"
    t.integer "work_id"
  ...
  create_table "saved_works", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "serial_works", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "series_id"
    t.integer "work_id"
    t.integer "position", default: 1
    t.datetime "created_at"
  ...
  create_table "set_taggings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "tag_id"
    t.integer "tag_set_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "skin_parents", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "skins", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "title"
    t.integer "author_id"
    t.text "css"
  ...
  create_table "spam_filters", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "stat_counters", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "work_id"
  ...
  create_table "tag_nominations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "type"
  ...
  create_table "tag_set_associations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "owned_tag_set_id"
    t.integer "tag_id"
  ...
  create_table "tag_set_nominations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "pseud_id"
    t.integer "owned_tag_set_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "tag_set_ownerships", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "pseud_id"
    t.integer "owned_tag_set_id"
  ...
  create_table "tag_sets", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "user_invite_requests", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id"
    t.integer "quantity"
    t.text "reason"
  ...
  create_table "videos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "video_file_meta"
    t.boolean "video_file_processing", default: false, null: false
    ...
    t.string "embed_pass"
    t.text "video_data"
    t.index ["embed_site"], name: "index_videos_on_embed_site"
    t.index ["work_id"], name: "index_videos_on_work_id"
  end

  create_table "work_links", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "work_id"
    t.string "url"
    t.integer "count"
    t.datetime "created_at"
  ...
  create_table "works", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "type", default: "TextWork", null: false
    t.integer "duration", default: 0, null: false
  ...
  create_table "wrangling_assignments", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id"
    t.integer "fandom_id"
  ...
  create_table "wrangling_guidelines", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "admin_id"
    t.string "title"
    t.text "content"
    t.datetime "created_at"
